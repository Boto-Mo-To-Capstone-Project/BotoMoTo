...
type PositionCandidatesModalProps = {
  open: boolean;
  onClose: () => void;
  positionName: string;
  positionId: number;
...
export function PositionCandidatesModal({
  open,
  onClose,
  positionName,
  positionId,
    ...
    >
      <div className="relative max-w-4xl max-h-screen p-10 flex flex-col justify-center w-full">
        <div className="bg-white rounded-lg shadow-sm overflow-y-auto max-h-[80vh]">
          ...
          {/* Modal body */}
          <div className="p-4">
            <p className="text-sm text-gray-500 mb-4">View all candidates running for this position.</p>
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  There are no candidates currently running for this position.
                </p>
              </div>
            ) : (
                ...
                <table className="w-full text-sm border-separate border-spacing-0">
                  <thead className="bg-gray-50">
                    <tr className="text-left text-gray-700 border-b font-semibold text-base">
                      ...
                      <th className="py-3 px-4 border-b border-gray-200">Party</th>
                    </tr>
                  </thead>
                  <tbody>
