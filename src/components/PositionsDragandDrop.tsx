        ...
        <div className="bg-white rounded-lg shadow-sm overflow-y-auto max-h-[80vh]">
          ...
          <div className="p-4">
            ...
            <div className="mb-4 text-sm text-gray-700">
              <p>
                <b>Instructions:</b> Download the template, fill it out with your positions, and use the Import button below to upload your CSV file.
              </p>
            </div>
            {/* Drag and Drop UI */}
            <div
