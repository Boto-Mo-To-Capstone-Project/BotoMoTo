...
export function TrialSendingModal({
  open,
  onClose,
  onSave,
  initialData = {
  ...
  disableSave,
  title = "Voter Form (Trial Sending)",
  submitLabel = "Add",
  votingScopes,
}: TrialSendingModalProps) {
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-y-auto max-h-[80vh]">
          ...
          <div className="p-4">
              <p className="text-sm text-gray-500 mb-4">
                You can still review and add voters to ensure they receive their voting credentials via email. You may also test the process by adding yourself as a sample voter to view the unique URL and access code that each voter will receive.
              </p>
